...
const PATHS = {
  ...
  whatsapp: (
    <>
      ...
      <path d="M8.7 8.9c.2-.5.5-.5.8-.5h.6c.2 0 .4 0 .6.5s.6 1.5.7 1.6c0 .1.1.3 0 .4-.1.2-.2.3-.3.5l-.4.4c-.1.2-.3.3-.1.6.2.3.8 1.2 1.7 2 1.2 1 2 1.3 2.4 1.4.3.1.5 0 .6-.1l.7-.8c.2-.2.4-.2.6-.1l1.7.8c.3.1.4.2.5.3 0 .2 0 .9-.3 1.5-.3.7-1.7 1.4-2.3 1.4-.6.1-1.3.3-4.2-.9-3.5-1.4-5.3-4.9-5.4-5.1-.1-.2-1-1.4-1-2.7s.7-1.9.9-2.2z" />
    </>
  ),
}
